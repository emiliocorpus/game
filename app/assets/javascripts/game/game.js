var game = new Phaser.Game(400, 800, Phaser.CANVAS, 'phaser-game', { preload: preload, create: create, update: update, render: render  });
...
function create() {
    ...
    // background image
    background = game.add.tileSprite(0, 0, 400, 800, "menubackground");
